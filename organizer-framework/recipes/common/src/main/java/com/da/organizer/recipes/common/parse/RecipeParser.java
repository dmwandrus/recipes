...
public class RecipeParser {
    ...
    public static RecipeIngredient parseIngredientString(final String ingredientString) {
        ...
        int commaIndex = ingredientStringTrim.indexOf(",");
        if (commaIndex > 0) {
        ...
        for (String part : split) {
            ...
            if (fractionMatcher.find()) {
                ...
                if (packageSplit.length == 2) {
                    ...
                    // just leave it as part of the ingredient string. 
                    restOfString = restOfString.concat(part).concat(" ");
                }
            } else {
                try {
...
/**
 * TODO:  *
 * Error #1: 2014-10-29 19:57:38,915 | ERROR | qtp1953167364-58 | RecipeParser |
 * 61 - com.da.organizer.recipes.model - 1.0.0.SNAPSHOT | Unable to parse number
 * of servings into number: 8 servings (serving size: about 1/2 cup).
 * java.lang.NumberFormatException: For input string: "8 servings (serving size:
 * about 1/2 cup)." - fixed
 *
 ...
 *
 * Original String : '1/4 c to 1/2 c sugar' - Not supported...
 * * 
Original String : '1/4 - 3/4 cup Red Chile Powder'
 *
 *
 ...
 * plus 6 whole leaves (for garnish)'
 * Honestly, I'm going to do this via data entry, and just put them on two separate lines
 *
 *
 * Error #9 Original String : '1/4 cup balsamic vinegar reduction or 2
 * tablespoons balsamic vinegar (see Note)' 
 * Data entry - either add a comma or put a 'substitute' tage in at the bottom
 *
 ...
 * crunchy salad of bite-size vegetables holds plenty of appeal."
 * fixed
 *
